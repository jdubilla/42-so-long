SRCS			= main.c get_next_line.c  get_next_line_utils.c init_struct.c\
				check_map.c error.c list_utils.c init_map.c exit_safe.c\
				moove_player.c init_win.c next_pos.c
